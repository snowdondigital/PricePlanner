...
<div class="form-grid">
<section class="card results primary-results"><h2>Calculation</h2><dl><div><dt>Total cost</dt><dd data-result="total_cost"><?= e(money($calc['total_cost'])) ?></dd></div><div><dt>Preferred sell price</dt><dd data-result="preferred_sell_price"><?= e(money($calc['preferred_sell_price'])) ?></dd></div><div><dt>Retail inc. VAT</dt><dd data-result="retail_price_inc_vat"><?= e(money($calc['retail_price_inc_vat'])) ?></dd></div><div><dt>Suggested trade</dt><dd data-result="suggested_trade_price"><?= e(money($calc['suggested_trade_price'])) ?></dd></div><div><dt>Actual trade discount</dt><dd data-result="actual_trade_discount"><?= e(percent($calc['actual_trade_discount'])) ?></dd></div><div><dt>Retail margin</dt><dd data-result="retail_margin"><?= e(percent($calc['retail_margin'])) ?></dd></div><div><dt>Trade margin</dt><dd data-result="trade_margin"><?= e(percent($calc['trade_margin'])) ?></dd></div><div><dt>Minimum price</dt><dd data-result="minimum_price"><?= e(money($calc['minimum_price'])) ?></dd></div></dl></section>
...
<section class="card"><h2>Pricing</h2><div class="fields"><label>Target margin %<input class="percent-input" type="number" step=".01" min="0" max="99.99" name="target_margin_pct" data-target="target_margin" value="<?= e((string)((float)$product['target_margin']*100)) ?>"><input type="hidden" name="target_margin" value="<?= e($product['target_margin']) ?>"></label><label>Retail price excl. VAT<input type="number" step=".0001" min="0" name="retail_price" value="<?= e($product['retail_price']) ?>"></label><label>MSRP<input type="number" step=".0001" min="0" name="msrp" value="<?= e($product['msrp']) ?>"></label><label>Preferred override<input type="number" step=".0001" min="0" name="preferred_price_override" value="<?= e($product['preferred_price_override']) ?>"></label></div></section>
<section class="card"><h2>Trade pricing</h2><div class="fields"><label>Target trade discount %<input class="percent-input" type="number" step=".01" min="0" max="99.99" name="trade_discount_pct" data-target="trade_discount" value="<?= e((string)((float)$product['trade_discount']*100)) ?>"><input type="hidden" name="trade_discount" value="<?= e($product['trade_discount']) ?>"></label><label>Actual trade price<input type="number" step=".0001" min="0" name="trade_price" value="<?= e($product['trade_price']) ?>"></label><label>Minimum margin %<input class="percent-input" type="number" step=".01" min="0" max="99.99" name="minimum_margin_pct" data-target="minimum_margin" value="<?= e((string)((float)$product['minimum_margin']*100)) ?>"><input type="hidden" name="minimum_margin" value="<?= e($product['minimum_margin']) ?>"></label></div></section>
